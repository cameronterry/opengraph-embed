...
== Description ==
A nicer and simple way of sharing or referencing content from other websites which do not support oEmbed. OpenGraph Embed will automagically convert URLs which sit standalone on a line within the text editor into a embed card similar.
...
For older releases, please see [the Releases page on Github](https://github.com/cameronterry/opengraph-embed/releases).
